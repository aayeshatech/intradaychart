...
SYMBOL_CONFIG = {
    ...
    'DRREDDY': {'name': 'Dr. Reddy\'s Labs', 'currency': '₹', 'default_price': 6800.0, 'sector': 'Pharma'),
    
    'GOLD': {'name': 'Gold Futures', 'currency': '$', 'default_price': 2050.0, 'sector': 'Precious Metals'},
    'DOWJONES': {'name': 'Dow Jones Industrial Average', 'currency': '$', 'default_price': 35000.0, 'sector': 'US Index'},
    'SILVER': {'name': 'Silver Futures', 'currency': '$', 'default_price': 25.50, 'sector': 'Precious Metals'},
    'CRUDE': {'name': 'Crude Oil WTI', 'currency': '$', 'default_price': 82.50, 'sector': 'Energy'},
    'BTC': {'name': 'Bitcoin', 'currency': '$', 'default_price': 65000.0, 'sector': 'Cryptocurrency'},
}
